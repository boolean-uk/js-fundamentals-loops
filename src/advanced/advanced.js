...
nums.sort((a, b) => a - b)
console.log(nums)
const middleOfArray = Math.floor(nums.length / 2)
console.log(nums[middleOfArray])
if (nums.length % 2 === 0) {
  median = Math.floor((nums[middleOfArray] + nums[middleOfArray - 1]) / 2)
} else {
  median = nums[middleOfArray]
}
