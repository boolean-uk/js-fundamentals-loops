...
console.log('divide count', divisibleByThreeCount)
...
console.log('info', smallest)
// 6. find the median of the numbers in the array
let median = 0
const sortedArray = nums.sort((a, b) => a - b)
console.log(sortedArray[sortedArray.length / 2 - 1])
median = sortedArray[sortedArray.length / 2 - 1]
module.exports = {
  hasTen,
  indexOfTen,
  divisibleByThreeCount,
