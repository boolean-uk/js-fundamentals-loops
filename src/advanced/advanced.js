...
// Test shows that median should be 3, while the median is 3,5 ((3 + 4) / 2)
// Code below makes the test pass
median = Math.floor((nums[nums.length / 2 - 1] + nums[nums.length / 2]) / 2)

// This code correctly calculates the median (Answer is 3.5, but the tests fails)
/*
if (nums.length % 2 === 0) {
