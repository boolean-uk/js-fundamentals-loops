...
for (let i = 0; i < nums.length; i++) {
  if (nums[i] === 10) {
      hasTen = true;
      indexOfTen = i;
      break; // exit the loop early once 10 is found
  }
}

console.log(hasTen); // Output: true if 10 is found, false otherwise
console.log(indexOfTen); // Output: index of 10 if found, -1 otherwise
